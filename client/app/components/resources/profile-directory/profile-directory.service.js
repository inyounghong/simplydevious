class ProfileDirectoryService {
    ...
    getUserCss(j) {
        ...
        var style = this._getStyle(j.style);
        var descriptionStyle = this._getStyle(j.descriptionStyle);
        var transitionStyle = this._getStyle(j.transitionStyle);
    ...
    setUpJournal() {
        ...
        j.style = this._setUpStyle();
        j.descriptionStyle = this._setUpStyle();
        j.transitionStyle = this._setUpStyle();

        j.buttons = this._setUpButtons();
        j.statusButtons = this._setUpStatusButtons();
    ...
    _setUpStatusButtons() {
        var buttons = [];
        for (var i = 0; i < this.NUM_STATUS_BUTTONS; i++) {
            buttons.push(this._newStatusButton());
        }
        return buttons;
    }
...
export default ProfileDirectoryService;
